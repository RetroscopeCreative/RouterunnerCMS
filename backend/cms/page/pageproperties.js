...
pageproperties = function(caller, selector) {
    ...
    this.label_change = function(value) {
        ...
        if (!this.url_changed_by_key) {
            var url = routerunner.settings["BACKEND_DIR"] + '/backend/ajax/common/label2ascii.php';
    ...
    this.content = function(fn) {
        ...
        var _fn = fn;
        var params = {};
        this.ajax(routerunner.settings["BACKEND_DIR"] + "/backend/ajax.php", params, function(data) {
