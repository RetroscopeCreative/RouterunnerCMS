...
var Layout = function () {
    ...
    var handleMainMenu = function () {
        ...
        $(".page-header .menu-toggler").on("click", function(event) {
            if (Metronic.getViewPort().width < resBreakpointMd) {
                var menu = $(".page-header .page-header-menu .hor-menu");
                if (menu.is(":visible")) {
                    menu.slideUp(300);
                } else {
                    menu.slideDown(300);
        ...
        $(window).scroll(function() {
            ...
            if ($(window).scrollTop() > offset){
                $(".page-header-to-fixed").addClass("fixed");
                $("body").addClass("top-fixed");
            } else {
                $(".page-header-to-fixed").removeClass("fixed");
    ...
    var handleContentHeight = function() {
        ...
        if ($('body').height() < Metronic.getViewPort().height) {
            ...
            ($('.page-container').outerHeight() - $('.routerunner-content').outerHeight()) -
            $('.page-prefooter').outerHeight() -
            $('.page-footer').outerHeight();

            $('.routerunner-content').css('min-height', height);
        }
    };
