(function($, moment)
{
	...
	function Plugin(element, options)
	{
		...
		this.params = { date : true, time : true, format : 'YYYY-MM-DD', minDate : null, maxDate : null, currentDate : null, lang : 'en', weekStart : 0, okButton: 'OK', cancelButton: 'CANCEL' };
									...
									'<div class="modal-content">' +
										'<div class="modal-body">' +
												...
												'<div class="dtp-date">' +
													'<div class="row">' +
														'<div class="col-sm-2 col-xs-2">' +
															'<a href="javascript:void(0);" class="dtp-select-month-before"><span class="fa fa-chevron-left"></span></a>' +
														'</div>' +
														'<div class="col-sm-8 col-xs-8 dtp-actual-month">MAR</div>' +
														'<div class="col-sm-2 col-xs-2">' +
															'<a href="javascript:void(0);" class="dtp-select-month-after"><span class="fa fa-chevron-right"></span></a>' +
														'</div>' +
													'</div>' +
													'<div class="dtp-actual-num">13</div>' +
													'<div class="row">' +
														'<div class="col-sm-2 col-xs-2">' +
															'<a href="javascript:void(0);" class="dtp-select-year-before"><span class="fa fa-chevron-left"></span></a>' +
														'</div>' +
														'<div class="col-sm-8 col-xs-8 dtp-actual-year">2014</div>' +
														'<div class="col-sm-2 col-xs-2">' +
															'<a href="javascript:void(0);" class="dtp-select-year-after"><span class="fa fa-chevron-right"></span></a>' +
														'</div>' +
													'</div>' +
												'</div>' +
											...
											'<div class="dtp-buttons">' +
												'<button class="dtp-btn-ok pull-right btn btn-flat">' + this.params.okButton + '</button>' +
												'<button class="dtp-btn-cancel pull-right btn btn-flat">' + this.params.cancelButton + '</button>' +
