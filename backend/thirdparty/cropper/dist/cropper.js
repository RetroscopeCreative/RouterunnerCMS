...
(function (factory) {
    ...
    $.extend(prototype, {
        ...
        setCanvasData: function (data) {
            var canvas = this.canvas,
                aspectRatio = (canvas ? canvas.aspectRatio : 1);
    ...
    $.fn.cropper = function (options) {
        ...
        this.each(function () {
            ...
            $window = $(this.ownerDocument.defaultView || this.ownerDocument.parentWindow);
            $document = $(this.ownerDocument);
            location = this.ownerDocument.defaultView.location || this.ownerDocument.parentWindow.location;
