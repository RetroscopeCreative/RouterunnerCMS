												...
												<table class="six columns">
													<tr>
														<td class="vertical-middle">
															<a href="<?=runner::config("BASE")?>">
																<img src="<?=runner::config("BASE")?>backend/img/appetizer-logo.png" width="86" border="0" alt=""/>
															</a>
														</td>
													</tr>
												</table>
														...
														<td>
															<table class="wrapper social-icons" align="right">
																<tr>
																	<td class="vertical-middle">
																		<a href="#">
																			<img src="<?=runner::config("BASE")?>metronic/assets/admin/pages/media/email/social_facebook.png" alt="social icon"/>
																		</a>
																	</td>
																	<td class="vertical-middle">
																		<a href="#">
																			<img src="<?=runner::config("BASE")?>metronic/assets/admin/pages/media/email/social_twitter.png" alt="social icon"/>
																		</a>
																	</td>
																	<td class="vertical-middle">
																		<a href="#">
																			<img src="<?=runner::config("BASE")?>metronic/assets/admin/pages/media/email/social_googleplus.png" alt="social icon"/>
																		</a>
																	</td>
																	<td class="vertical-middle">
																		<a href="#">
																			<img src="<?=runner::config("BASE")?>metronic/assets/admin/pages/media/email/social_linkedin.png" alt="social icon"/>
																		</a>
																	</td>
																	<td class="vertical-middle">
																		<a href="#">
																			<img src="<?=runner::config("BASE")?>metronic/assets/admin/pages/media/email/social_rss.png" alt="social icon"/>
																		</a>
																	</td>
																</tr>
															</table>
							...
							<tr>
								<td class="wrapper last">
									...
									<table class="twelve columns" style="margin-bottom: 10px">
										<tr>
											<td class="panel">
												<a href="<?=context::get("confirm_code")?>"><?=context::get("confirm_code")?></a>
											</td>
											<td class="expander">
											</td>
										</tr>
									...
									<table class="twelve columns">
										<tr>
											<td>
												...
												<img src="<?=runner::config("BASE")?>metronic/assets/admin/pages/media/email/article.png" class="ie10-responsive" alt=""/>
											</td>
											<td class="expander">
											</td>
										</tr>
